...
export default function Center3() {
  return (
    <div className='2xl:justify-center'>
        <div className='2xl:justify-center' style={{marginTop:"150px"}}><p style={{fontSize:"16px",fontWeight:"400",color:"#A7ABB6",lineHeight:"18.3px",textAlign:"center"}}>Project</p>
        ...
        <p className='2xl:justify-center xl:justify-center' style={{fontSize:"16px",fontWeight:"400",lineHeight:"28px",color:"#A7ABB6",textAlign:"center",marginTop:"20px",paddingRight:"365px",paddingLeft:"279px"}}>success is not just a goal; it&apos;s a standard we strive for in every project we<br></br> undertake. Our portfolio is a testament to the diverse range of successful<br></br> projects that showcase our innovation, technical expertise, and unwavering<br></br> commitment to delivering outstanding results.</p>
        </div>
