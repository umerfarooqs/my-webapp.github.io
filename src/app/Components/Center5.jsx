...
export default function Center5() {
  return (
    <div className='flex 2xl:justify-center xl:justify-center' style={{backgroundColor:"#0041E8",borderRadius:"32px",marginTop:"85px",marginLeft:"50px",marginRight:"50px",marginBottom:"70px"}}>
